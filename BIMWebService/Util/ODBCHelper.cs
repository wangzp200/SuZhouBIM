...
namespace BIMWebService.Util
{
    ...
    public static class OdbcHelper
    {
        ...
        ///     an array of OdbcParameters to be associated with the command or 'null' if no parameters
        ///     are required
        /// </param>
        private static void PrepareCommand(OdbcCommand command, OdbcConnection connection, OdbcTransaction transaction,
            CommandType commandType, string commandText, OdbcParameter[] commandParameters)
        {
        ...
        /// <remarks>
        ///     e.g.:
        ///     int result = ExecuteNonQuery(connString, CommandType.StoredProcedure, "PublishOrders", new OdbcParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a OdbcConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        ...
        /// </summary>
        /// <remarks>
        ///     This method provides no access to output parameters or the stored procedure'bizObjectService return value
        ///     parameter.
        ///     e.g.:
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                var commandParameters = OdbcHelperParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(OdbcConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                //pull the parameters for this stored procedure from the parameter cache (or discover them & populate the cache)
                var commandParameters = OdbcHelperParameterCache.GetSpParameterSet(connection.ConnectionString, spName);
        ...
        ///     OdbcTransaction using the provided parameter values.  This method will query the database to discover the
        ///     parameters for the
        ///     stored procedure (the first time each stored procedure is called), and assign the values based on parameter order.
        /// </summary>
        /// <remarks>
        ...
        public static int ExecuteNonQuery(OdbcTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                var commandParameters =
                    OdbcHelperParameterCache.GetSpParameterSet(transaction.Connection.ConnectionString, spName);
        ...
        /// <remarks>
        ///     e.g.:
        ///     DataSet ds = ExecuteDataset(connString, CommandType.StoredProcedure, "GetOrders", new OdbcParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a OdbcConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        ...
        private static OdbcDataReader ExecuteReader(OdbcConnection connection, OdbcTransaction transaction,
            CommandType commandType, string commandText, OdbcParameter[] commandParameters,
            OdbcConnectionOwnership connectionOwnership)
        {
            //create a command and prepare it for execution
            var cmd = new OdbcCommand();
        ...
        /// <remarks>
        ///     e.g.:
        ///     OdbcDataReader dr = ExecuteReader(connString, CommandType.StoredProcedure, "GetOrders", new
        ///     OdbcParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connectionString">a valid connection string for a OdbcConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
            ...
            params OdbcParameter[] commandParameters)
        {
            ...
            try
            {
                ...
                return ExecuteReader(cn, null, commandType, commandText, commandParameters,
                    OdbcConnectionOwnership.Internal);
            }
            catch
            {
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a OdbcDataReader containing the resultset generated by the command</returns>
        public static OdbcDataReader ExecuteReader(string connectionString, string spName,
        ...
        /// <param name="commandText">the stored procedure name or T-SQL command</param>
        /// <returns>a OdbcDataReader containing the resultset generated by the command</returns>
        public static OdbcDataReader ExecuteReader(OdbcConnection connection, CommandType commandType,
            string commandText)
        {
            //pass through the call providing null for the set of OdbcParameters
        ...
        /// <remarks>
        ///     e.g.:
        ///     OdbcDataReader dr = ExecuteReader(conn, CommandType.StoredProcedure, "GetOrders", new OdbcParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="connection">a valid OdbcConnection</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a OdbcDataReader containing the resultset generated by the command</returns>
        public static OdbcDataReader ExecuteReader(OdbcConnection connection, string spName,
            params object[] parameterValues)
        {
            //if we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
        ...
        /// <remarks>
        ///     e.g.:
        ///     OdbcDataReader dr = ExecuteReader(trans, CommandType.StoredProcedure, "GetOrders", new OdbcParameter("@prodid",
        ///     24));
        /// </remarks>
        /// <param name="transaction">a valid OdbcTransaction</param>
        /// <param name="commandType">the CommandType (stored procedure, text, etc.)</param>
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a OdbcDataReader containing the resultset generated by the command</returns>
        public static OdbcDataReader ExecuteReader(OdbcTransaction transaction, string spName,
            params object[] parameterValues)
        {
            //if we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
            ...
            params OdbcParameter[] commandParameters)
        {
            ...
            //create the DataAdapter & DataSet
            var ds = ExecuteDataset(connection, commandType, commandText, commandParameters);
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>an XmlReader containing the resultset generated by the command</returns>
        public static XmlReader ExecuteXmlReader(OdbcConnection connection, string spName,
            params object[] parameterValues)
        {
            //if we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
        ...
        /// <param name="commandText">the stored procedure name or T-SQL command using "FOR XML AUTO"</param>
        /// <returns>an XmlReader containing the resultset generated by the command</returns>
        public static XmlReader ExecuteXmlReader(OdbcTransaction transaction, CommandType commandType,
            string commandText)
        {
            //pass through the call providing null for the set of OdbcParameters
            ...
            string commandText, params OdbcParameter[] commandParameters)
        {
            ...
            //create the DataAdapter & DataSet
            var ds = ExecuteDataset(transaction, commandType, commandText, commandParameters);
            XmlReader retval = new XmlTextReader(new StringReader(ds.GetXml()));
        ...
        /// <param name="parameterValues">an array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static XmlReader ExecuteXmlReader(OdbcTransaction transaction, string spName,
            params object[] parameterValues)
        {
            //if we receive parameter values, we need to figure out where they go
            if ((parameterValues != null) && (parameterValues.Length > 0))
    ...
    /// </summary>
    public static class OdbcHelperParameterCache
    {
        ...
        /// <returns></returns>
        private static OdbcParameter[] DiscoverSpParameterSet(string connectionString, string spName,
            bool includeReturnValueParameter)
        {
            using (var cn = new OdbcConnection(connectionString))
            using (var cmd = new OdbcCommand(spName, cn))
            {
                cn.Open();
                ...
                var discoveredParameters = new OdbcParameter[cmd.Parameters.Count];
                ;
        ...
        {
            var clonedParameters = new OdbcParameter[originalParameters.Length];
        ...
        public static OdbcParameter[] GetCachedParameterSet(string connectionString, string commandText)
        {
            ...
            var cachedParameters = (OdbcParameter[]) ParamCache[hashKey];
